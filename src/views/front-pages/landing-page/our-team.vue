...
const teamData = ref([
  { name: 'Shariifah Dah', position: 'Directrice Générale', image: teamPerson1, backgroundColor: 'rgba(46, 125, 50, 0.16)', borderColor: 'rgba(46, 125, 50, 0.16)', isHover: false },
  { name: 'Shariifah Dah', position: 'Responsable Pédagogique', image: teamPerson2, backgroundColor: 'rgba(46, 125, 50, 0.16)', borderColor: 'rgba(46, 125, 50, 0.16)', isHover: false },
  { name: 'Shariifah Dah', position: 'Chef de Projet', image: teamPerson3, backgroundColor: 'rgba(46, 125, 50, 0.16)', borderColor: 'rgba(46, 125, 50, 0.16)', isHover: false },
  { name: 'Shariifah Dah', position: 'Responsable Marketing', image: teamPerson4, backgroundColor: 'rgba(46, 125, 50, 0.16)', borderColor: 'rgba(46, 125, 50, 0.16)', isHover: false },
])
</script>
    ...
    <div class="our-team pa-">
      <div class="headers d-flex justify-center flex-column align-center">
        ...
        <p class="text-center text-body-1 mb-0">
          Qui se cache derrière cette plateforme d'apprentissage innovante ?
        </p>
      </div>
