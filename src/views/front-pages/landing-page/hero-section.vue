        ...
        <VContainer>
          <div class="hero-text-box text-center px-6">
            <h1 class="hero-title mb-4">
              Une plateforme pour développer toutes vos compétences
            </h1>
            <h6 class="mb-6 text-h6">
              Plateforme d'apprentissage innovante et intuitive
              pour la fiabilité et la personnalisation de votre parcours.
            </h6>
