...
const demoList = [
  { title: 'Cours en ligne', to: '#' },
  { title: 'Exercices pratiques', to: '#' },
  { title: 'Évaluations', to: '#' },
        ...
        <VRow>
          ...
          >
            ...
            >
              ...
              >
                Plateforme d'apprentissage innovante 🌱 pour développer vos compétences avec des cours interactifs et un suivi personnalisé.
              </div>
        ...
        <div class="d-flex justify-space-between flex-wrap gap-y-5 align-center">
          ...
          <div class="d-flex gap-x-6">
            <template
              ...
              { title: 'youtube', icon: 'tabler-brand-youtube-filled', href: '#' },
              ]"
              :key="index"
            >
              <a
