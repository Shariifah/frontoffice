...
const colors: { main: string; darken: string }[] = [
  ...
  { main: '#4CAF50', darken: '#388E3C' },
  { main: '#8BC34A', darken: '#689F38' },
  { main: '#CDDC39', darken: '#AFB42B' },
  { main: '#FF9800', darken: '#F57C00' },
  { main: '#FF5722', darken: '#E64A19' },
]

const customPrimaryColor = ref('#2E7D32')
