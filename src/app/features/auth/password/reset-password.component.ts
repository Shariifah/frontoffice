      ...
      <div class="bg-white rounded-2xl shadow-lg w-full max-w-md p-8">
        ...
        <form class="space-y-4" [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <div>
            ...
            ></p-password>
            <div [@if]="form.get('newPassword')?.invalid && form.get('newPassword')?.touched" class="text-red-500 text-sm mt-1">
          ...
          <div>
            ...
            ></p-password>
            <div [@if]="form.get('confirmPassword')?.invalid && form.get('confirmPassword')?.touched" class="text-red-500 text-sm mt-1">
